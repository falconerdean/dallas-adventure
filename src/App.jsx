...
const stops = [
  {
    ...
    hints: [
      ...
      "About 40 minutes south into the heart of Dallas",
      "Our Uber awaits at the Hyatt Regency lobby",
    ],
  ...
  },
  {
    ...
    hints: [
      "A service that holds your stuff while you play",
      "Right in the West End, steps from our first stop",
      "Bounce luggage storage — in and out!",
    ],
  ...
  },
  {
    ...
    hints: [
      "November 22, 1963 — a motorcade and a moment",
      "Find the X marks on Elm Street",
      "The Grassy Knoll is just a few steps away",
    ],
  ...
  },
  {
    ...
    hints: [
      ...
      "Timed entry at 10:15 — we have tickets",
      "Standing at that window is something you won't forget",
    ],
  ...
  },
  {
    ...
    hints: [
      "It's a deck park — built over a freeway",
      "Food trucks, games, and green space in the middle of downtown",
      "Named after a Dallas civic leader",
    ],
  ...
  },
  {
    ...
    hints: [
      ...
      "Colorful, bold, and meant to be shared over margaritas on the patio",
    ],
  ...
  },
  {
    ...
    hints: [
      ...
      "A garden by the lake with gorgeous views over the water",
      "Half a million spring blooms and azaleas nearing peak",
    ],
  ...
  },
  {
    ...
    hints: [
      "Back to the West End — about 20 minutes",
      "Bounce gives our bags back, quick and easy",
      "Then a 25-minute ride to the airport",
    ],
  ...
  },
  {
    ...
    hints: [
      ...
      "Across from gate D12, about 90 minutes to relax",
    ],
  ...
  },
  {
    ...
    hints: [
      "Skylink from Terminal D back to Terminal E",
      "Gate E11 is calling",
      "AS 317 — next stop, the Pacific Northwest",
    ],
