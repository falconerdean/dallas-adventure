...
const stops = [
  ...
  },
  {
    time: "Midday",
    emoji: "🌶️",
    riddle: "Ancient gods once ground these beans — not for your morning cup, but for moles and dreams. Where Oaxaca meets the city of cowboys, flavors dance with ancestral joys.",
    hints: [
      "Cocoa is the secret, but this isn't dessert",
      "A civilization between two others gives it its name",
      "McKinney Avenue holds the door",
    ],
    answer: "Meso Maya Comida y Copas",
    description: "Lunch at a restaurant where every dish is a love letter to the interior regions of Mexico. Expect hand-ground corn tortillas and mole that takes days to make.",
